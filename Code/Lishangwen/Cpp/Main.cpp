...
int main(){
	...
	{ 
		{13,1,14,4,3,10,12,9,6,7} ,
		{9,10,0,7,5,13,6,14,2,3,11,15},
		{13,11,15,7,5,3,1,6,14,9},{14,5,12,0,2,8,1,15},
		{11,6,8,7,10,14,0,15,13,12},
		{7,3,8,9,1,10,2,13,12,15,6},
		{9,4,12,15,11,1,14,10,13,2,0,8,5},
		{12,5,8,4,15,1,2,11,14,10,0},
		{15,4,7,5,13,11,10,3,9,6},
		{6,12,1,5,11,15,0,10,8,14,2},
		{14,11,12,1,4,5,0,8,9,6,15,7},
		{4,2,10,12,9,8,6,14,7,1,15},
		{7,9,15,10,11,6,3,0,13,14,5,4},
		{0,2,8,1,5,12,6,4},
		{3,10,0,4,1,6,11,15,7,12,9,2},
		{8,12,7,6,2,9,14,4,3,10,1,5,11}
	};
	auto result = lib.watchedVideosByFriends(watchedVideos, friends, 11, 1);
	cout << result.size();
